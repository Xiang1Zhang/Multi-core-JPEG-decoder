...
#define MB1_FIFO_RWC_p 	      (int*)(mb4_cmemin0_pt_REMOTEADDR+3*sizeof(int)+4*sizeof(From3_to_4))
...
#define MB1_FIFO_RBUFFER_p    (int*)(mb4_cmemin0_pt_REMOTEADDR+4*sizeof(int)+4*sizeof(From3_to_4))
...
#define MB2_FIFO_RWC_p 	  (int*)(mb4_cmemin0_pt_REMOTEADDR+5*sizeof(int)+4*sizeof(From3_to_4)+2*sizeof(From1_to_4))
...
#define MB2_FIFO_RBUFFER_p   (int*)(mb4_cmemin0_pt_REMOTEADDR+6*sizeof(int)+4*sizeof(From3_to_4)+2*sizeof(From1_to_4))
...
#define MB4_FIFO_WC_c1  	  (int*)(mb4_cmem0_BASEADDR+3*sizeof(int)+4*sizeof(From3_to_4))
#define MB4_FIFO_RWC_c1 	  (int*)(NULL)
#define MB4_FIFO_RC_c1  	  (int*)(mb4_cmem0_BASEADDR+2*sizeof(int)+4*sizeof(From3_to_4))
#define MB4_FIFO_RRC_c1 	  (int*)(mb1_cmemin0_pt_REMOTEADDR+2*sizeof(int)+2*sizeof(From3_to_1))
#define MB4_FIFO_BUFFER_c1    (int*)(mb4_cmem0_BASEADDR+4*sizeof(int)+4*sizeof(From3_to_4))
#define MB4_FIFO_RBUFFER_c1   (int*)(NULL)

#define MB4_FIFO_WC_c2  	  (int*)(mb4_cmem0_BASEADDR+5*sizeof(int)+4*sizeof(From3_to_4)+2*sizeof(From1_to_4))
#define MB4_FIFO_RWC_c2 	  (int*)(NULL)
#define MB4_FIFO_RC_c2  	  (int*)(mb4_cmem0_BASEADDR+4*sizeof(int)+4*sizeof(From3_to_4)+2*sizeof(From1_to_4))
#define MB4_FIFO_RRC_c2 	  (int*)(mb2_cmemin0_pt_REMOTEADDR+2*sizeof(int)+2*sizeof(From3_to_2))
#define MB4_FIFO_BUFFER_c2    (int*)(mb4_cmem0_BASEADDR+6*sizeof(int)+4*sizeof(From3_to_4)+2*sizeof(From1_to_4))
